...
export async function POST(request) {
  ...
  const agreementVersion = "September 15, 2026";
  ...
  const leadResponse = await resendEmail({
      ...
      html: `<h2>New Oramusa website request</h2><p><strong>Template:</strong> ${escapeHtml(body.template)}</p><p><strong>Business:</strong> ${escapeHtml(body.business)}</p><p><strong>Industry:</strong> ${escapeHtml(body.industry)}</p><p><strong>Name:</strong> ${escapeHtml(body.name)}</p><p><strong>Email:</strong> ${escapeHtml(body.email)}</p><p><strong>Phone:</strong> ${escapeHtml(body.phone)}</p><p><strong>Domain:</strong> ${escapeHtml(body.domain || "None")}</p><p><strong>Website Service Agreement accepted:</strong> Yes</p><p><strong>Agreement version:</strong> ${agreementVersion}</p><p><strong>Terms of Service accepted:</strong> Yes</p><p><strong>Accepted at:</strong> ${escapeHtml(agreementAcceptedAt)}</p><p><strong>Notes:</strong><br>${escapeHtml(body.notes || "None")}</p>`
  });
