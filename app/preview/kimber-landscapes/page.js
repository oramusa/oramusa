...
export default function KimberLandscapesPreview() {
  return <main className="gPage" id="top">
    ...
    <section className="gHero"><img src="/ChatGPT Image Sep 16, 2026, 11_14_12 PM.png" alt="Well-kept suburban Florida home with professionally maintained lawn and landscaping"/><div className="gShade"/><div className="gHeroCopy"><p>LANDSCAPING · OVIEDO, FLORIDA</p><h1>Your lawn should<br/>look good. <em>Every week.</em></h1><p className="gLead">Professional lawn care and landscaping for Oviedo and surrounding Central Florida communities.</p><div><a className="gPrimary" href="tel:+14074845997">Call for an estimate →</a><a className="gText" href="#services">Explore services ↓</a></div></div><div className="gHeroFoot"><span>SERVING CENTRAL FLORIDA SINCE 2003</span><span>RESIDENTIAL · COMMERCIAL · HOA</span></div></section>
