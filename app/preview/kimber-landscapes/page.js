...
export const metadata = {
  title: "A Website Concept for Kimber Landscapes | Oramusa",
  description: "A private website concept prepared by Oramusa for Kimber Landscapes in Oviedo, Florida.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "A Website Concept for Kimber Landscapes",
    description: "A private website concept prepared by Oramusa.",
    images: [{ url: "/ChatGPT Image Sep 16, 2026, 11_14_12 PM.png", width: 1536, height: 1024, alt: "Kimber Landscapes website concept" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "A Website Concept for Kimber Landscapes",
    description: "A private website concept prepared by Oramusa.",
    images: ["/ChatGPT Image Sep 16, 2026, 11_14_12 PM.png"],
  },
};
...
export default function KimberLandscapesPreview() {
  return <main className="gPage" id="top">
    ...
    <header className="gNav"><Link className="gLogo" href="#top">KIMBER<span>LANDSCAPES</span></Link><nav><a href="#services">Services</a><a href="#work">Experience</a><a href="#about">About</a></nav><a className="gQuote" href="tel:+14074845997">Call for an estimate</a></header>
    <section className="gHero"><img src="/ChatGPT Image Sep 16, 2026, 11_14_12 PM.png" alt="Well-kept suburban Florida home with professionally maintained lawn and landscaping"/><div className="gShade"/><div className="gHeroCopy"><p>LANDSCAPING · OVIEDO, FLORIDA</p><h1>Your property deserves<br/><em>great landscaping.</em></h1><p className="gLead"><strong>Expertly maintained. Dependable care.</strong><br/>Professional lawn care and landscaping for homes, businesses, and communities throughout Oviedo and Central Florida.</p><div><a className="gPrimary" href="tel:+14074845997">Call for an estimate →</a><a className="gText" href="#services">Explore services ↓</a></div></div><div className="gHeroFoot"><span>SERVING CENTRAL FLORIDA SINCE 2003</span><span>RESIDENTIAL · COMMERCIAL · HOA</span></div></section>
