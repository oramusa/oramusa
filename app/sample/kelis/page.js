...
export default function KelisPhotography(){
  return <main className="ka">
    ...
    <header className="nav">
      <Link className="brand" href="#top">KELIS APONTE<span>PHOTOGRAPHY</span></Link>
    ...
    <footer className="footer"><Link className="brand" href="#top">KELIS APONTE<span>PHOTOGRAPHY</span></Link><p>Winter Park · Orlando · Central Florida</p><p className="note">Private concept prepared by Oramusa · © 2026</p></footer>
